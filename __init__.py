...
bl_info = {
    ...
    "warning"     : "Unstable Beta release – update to official release when available",  # used for warning icon and text in addons panel
...
developer_mode = 0  # NOTE: Set to 0 for release, 1 for developer mode
