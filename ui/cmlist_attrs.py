...
class CreatedModelProperties(bpy.types.PropertyGroup):
    ...
    run_animated_frames = IntProperty(default=0)
    ...
    # v1.6
    modelLoc = StringProperty()
    modelRot = StringProperty()
    modelScale = StringProperty()
    ...
    studDetail = StringProperty()
    logoType = StringProperty()
    logoResolution = IntProperty()
    logoDecimate = FloatProperty()
    logoScale = FloatProperty()
    logoInset = FloatProperty()
    hiddenUndersideDetail = StringProperty()
    exposedUndersideDetail = StringProperty()
    ...
    BFMCache = StringProperty()
    modelCreated = BoolProperty()
    numAnimatedFrames = IntProperty()
    framesToAnimate = IntProperty()
    modelCreatedOnFrame = IntProperty()
