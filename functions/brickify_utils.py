...
def draw_updated_bricks(cm, bricksdict, keys_to_update, action="redrawing", select_created=True, run_post_operations=True, placeholder_meshes=False):
...
def create_new_bricks(source_dup, parent, source_details, dimensions, action, split=True, cm=None, cur_frame=None, bricksdict=None, keys="ALL", clear_existing_collection=True, select_created=False, print_status=True, placeholder_meshes=False, run_pre_merge=True, run_post_merge=True, run_post_hollow=True, orig_source=None, redrawing=False):
